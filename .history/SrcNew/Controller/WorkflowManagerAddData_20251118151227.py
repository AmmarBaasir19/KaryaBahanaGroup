        ...
        try : 
            if value1 or value2 : 
                ...
                if ComponentsButton().button_update_all():
                    ...
                    st.write(f"Ini start_processing : {len(SessionManager().get_setter_state(key='start_processing'))}")
                    st.write(f"Ini sum_processing : {len(SessionManager().get_setter_state(key='sum_processing'))}")
