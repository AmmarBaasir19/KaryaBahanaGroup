                ...
                st.markdown("""
                    <div class="tooltip">❗
                        <span class="tooltiptext">
                            ...
                            • Ketika anda sudah menggunakan tombol ini untuk menampilkan data invalid berdasarkan halaman dan tabel yang ditampilkan berisi None (kosong). maka ini menandakan halaman tersebut tidak memiliki nilai Invalid. <br><br>
                            
                            <b>Pilihan Tipe Invalid</b><br><br>
                            • 
                        </span>
                    </div>
                    """, unsafe_allow_html=True)
