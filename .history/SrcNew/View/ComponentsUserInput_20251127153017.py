    ...
    def reports_input(self, label):
        ...
        with col1:
            with st.expander(label="📤 Tekan Untuk Membuat Reports Otomatis Berdasarkan Tanggal"):
                rows = row([2,2,2,1], vertical_align="bottom")
                ...
                <div class="tooltip">❗
                    <span class="tooltiptext">
                        ...
                        • Pilih Format reports sesaui yang anda butuhkan : <br>
                            • Format 1 : Report Summary (Reports dibuat dengan tidak memperdulikan Shift) <br>
                            • Format 2 : Report Detail (Reports dibuat dengan memperdulikan Shift) <br>
                    </span>
                </div>
                """, unsafe_allow_html=True)
