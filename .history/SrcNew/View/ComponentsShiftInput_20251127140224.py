            ...
            st.markdown("""
                <div class="tooltip">❗
                    <span class="tooltiptext">
                        ...
                        • Anda wajib menekan tombol <b>Perbarui Shift<b> setelah anda melakukan perubahan nilai shift (Apabila nilai shift yang anda ubah disimpan atau dijalankan oleh sistem). <br>
                        • Harap cek ulang data shift di dalam tabel dan cocokkan dengan Form Final Defects atau First Pass Defects, sebelum anda menekan tombol ini. <br>
                        • Untuk menggunakan tombol ini, anda cukup menekan tulisan <b> Ubah Shift Berdasarkan Halaman<b>, lalu tekan kotak pilihan halaman untuk memilih halaman yang ingin diubah shiftnya. dan tekan kotak pilihan shift untuk memilih shift yang ingin diubah (shift yang sesuai dengan Form Final Defects atau First Pass Defects).
                    </span>
                </div>
                """, unsafe_allow_html=True)
