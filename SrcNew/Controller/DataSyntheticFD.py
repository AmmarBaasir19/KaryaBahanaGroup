...
class DataSyntheticFD:
    def miss_table(self, df):
        """"""
        try : 
            table_reference = {'table_1' : ControllerPath().table_1_fd['columns_name'],
                               'table_2' : ControllerPath().table_2_fd['columns_name'],
                               'table_3' : ControllerPath().table_3_fd['columns_name'],
                               'table_4' : ControllerPath().table_4_fd['columns_name'],
                               'table_6' : ControllerPath().table_6_fd['columns_name']}
