...
class ComponentsButton:
    ...
    def button_download(self):
        ...
        cols = st.columns(1)[0]
        with cols: 
            option1 = st.button("💾 Simpan Data Hasil Pindai", key="download_button", use_container_width=True, help='Tekan Tombol ini untuk menyimpan data hasil pindai yang sudah dibaca kedalam data perusahaan')
