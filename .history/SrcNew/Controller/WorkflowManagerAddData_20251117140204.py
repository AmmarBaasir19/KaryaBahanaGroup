        ...
        try : 
            if value1 or value2 : 
                ...
                if ComponentsButton().button_download(): 
                    ...
                    df_users_temp = df_users_temp.rename(columns={'user_name': 'user_name',
                                                                  'name': 'name',
                                                                  'nik': 'nik_nipm',
                                                                  'location': 'location',
                                                                  'role': 'role',
        ...
        try : 
            if value1:
                ...
                if ComponentsButton().button_download(): 
                    ...
                    SessionManager().generate_dataframe('dataframe_users', 1, 6, "User_Name", "Name", "Nik", "Location", "Role", "Login_Id")  
