...
class ComponentsButton:
    ...
    def button_download(self):
        ...
        with col1: 
            option1 = st.button("💾 Simpan Data Hasil Pindai", key="download_button", use_container_width=True)

        with col2:
            with st.popover():
                st.write("""
                Tekan Tombol ini untuk menyimpan data hasil pindai yang sudah dibaca kedalam data perusahaan
                """)
