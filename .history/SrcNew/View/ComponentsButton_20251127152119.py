...
class ComponentsButton:
            ...
            st.markdown("""
                <div class="tooltip">❗
                    <span class="tooltiptext">
                        <b>Informasi Tombol Unduh PDF Yang Tidak Dapat Di Baca Sistem</b><br><br>
                        • Anda dapat menggunakan tombol ini untuk mendapatkan File PDF yang tidak dapat dibaca oleh sistem. <br>
                        • File PDF yang diberikan akan berjumlah 1 file PDF
                    </span>
                </div>
                """, unsafe_allow_html=True)
    ...
    def save_manual_input(self):
        ...
        col1, col2 = st.columns([3, 0.2])
        with col1: 
            option1 = st.button(label="💾 Simpan Data Hasil Input Manual", key="btn_manual_input", use_container_width=True)

        with col2:
            st.markdown("""
                <div class="tooltip">❗
                    <span class="tooltiptext">
                        <b>Informasi Tombol Simpan Data Hasil Input Manual</b><br><br>
                        • Ketika anda menekan tombol ini, maka data hasil inputan manual akan disimpan otomatis pada penyimpanan data perusahaan. <br>
                        • Gunakan tombol ini apabila sistem tidak dapat membaca form secara otomatis.
                    </span>
                </div>
                """, unsafe_allow_html=True)
    ...
    def button_start(self, tahun, bulan, tanggal, form_type): 
        ...
        with col2:
            st.markdown("""
                <div class="tooltip">❗
                    <span class="tooltiptext">
                        <b>Informasi Tombol Mulai Lakukan Pembacaan Form</b><br><br>
                        • Anda wajib menekan tombol ini untuk mulai melakukan pembacaan form. <br>
                        • Data Tahun, Bulan, Tanggal, dan Tipe Form yang anda pilih akan otomatis dimasukkan dalam sistem ketika anda menekan tombol Mulai Lakukan Pembacaan Form. <br>
                        • Data Tahun, Bulan, dan Tanggal hasil pemindaian akan otomatis diubah sesuai dengan <b>Data Tahun, Bulan, dan Tanggal <b> yang anda pilih. <br>
                    </span>
                </div>
                """, unsafe_allow_html=True)
        return btn
