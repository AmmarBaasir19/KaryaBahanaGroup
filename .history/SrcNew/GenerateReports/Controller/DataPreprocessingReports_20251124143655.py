...
class DataPreprocessingReports:
    ...
    def run(self, df1: pd.DataFrame, df2: pd.DataFrame) -> pd.DataFrame:
        ...
        try : 
            ...
            print(f"Ini setelah change_data_type df1 info : {df1.info()})") 
            print(f"Ini setelah change_data_type df2 : {df2})") 
            print(f"Ini setelah change_data_type df2 info : {df2.info()})")
