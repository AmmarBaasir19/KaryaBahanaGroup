...
class ComponentsButton:
        ...
        **Display Error Processing Button** <br>
        ...
        with cols:
            ...
            if st.download_button(
                ...
                self.delete_all_files("apps/storage/PDF_Problem")
    ...
    def button_download(self):
        ...
        cols = st.columns(1)[0]
        with cols: 
            option1 = st.button("💾 Simpan Data Hasil Pindai", key="download_button")
    ...
    def button_update(self):
        ...
        cols = st.columns(1)[0]
        with cols: 
            option1 = st.button("🔁 Perbarui Data Hasil Pindai", key="update_button")
