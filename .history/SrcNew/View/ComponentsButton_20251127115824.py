...
class ComponentsButton:
    ...
    def button_download(self):
        ...
        with col2:
            with st.popover("ℹ️"):
                st.write("""
                **Informasi Tombol Simpan Data Hasil Pindai** \n
                - Menyimpan data hasil pindai kedalam penyimpanan data perusahaan
                """)
    ...
    def button_update_all(self):
        ...
        with col2:
            st.markdown("""
                <div class="tooltip"><img src="https://cdn-icons-png.flaticon.com/512/471/471664.png" width="20">
